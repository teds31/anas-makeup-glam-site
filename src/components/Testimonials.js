      ...
      <Carousel className="d-flex align-items-center" style={{height: "auto", width: "100%"}} interval={9000}>
        ...
        <Carousel.Item>
          <div className="carousel-card">
            ...
            <div className="card-txt-holder">
              <p>I needed to get my make up done for a photo shoot and I knew the right person for that! @anas_makeup_glam and needless to say she did a great job!</p>
